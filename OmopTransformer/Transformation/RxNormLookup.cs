...
// checked by tom - 26/02/26
            ...
            { "arachis oil", new ValueWithNote("19033278", "peanut oil") }, //arachis oil, also known as peanut or groundnut oil
            ...
            { "amidotrizoate", new ValueWithNote("19022596", "diatrizoate") }, //diatrizoate, also known as amidotrizoate
            ...
            { "colestyramine", new ValueWithNote("19095309", "cholestyramine resin") }, // colestyramine and colestyramine resin refer to the same medication
            ...
            { "dexamfetamine", new ValueWithNote("719311", "dextroamphetamine") }, //dexamphetamine and dextroamphetamine are the same compound
            ...
            { "diamorphine", new ValueWithNote("19022417", "heroin") }, // heroin and diamorphine are the exact same chemical substance
            ...
            { "eftrenonacog alfa", new ValueWithNote("44818493", "coagulation factor ix recombinant immunoglobulin g1 fusion protein") }, // one is the generic name; the other describes its structure
            ...
            { "cyanocobalamin", new ValueWithNote("1308738", "vitamin b12") }, // specific, manufactured form of Vitamin B12 used in supplements and injections
            ...
            { "fampridine", new ValueWithNote("40170680", "dalfampridine") }, // UK vs USAN name for the same drug
            ...
            { "dosulepin", new ValueWithNote("19037989", "dothiepin") }, // dosulepin is the name used in the UK and dothiepin is the name used in the US
            ...
            { "factor viii inhibitor bypassing fraction", new ValueWithNote("19080406", "anti-inhibitor coagulant complex") }, // UK vs USAN name for the same drug
            ...
            { "hexaminolevulinate", new ValueWithNote("43532423", "hexyl 5-aminolevulinate") }, // chemical vs drug name
            ...
            { "ginkgo", new ValueWithNote("1391889", "ginkgo biloba extract") }, // ginkgo and ginkgo biloba extract refer to the same medication
            { "haloperidol", new ValueWithNote("766529", "haloperidol") },
            { "honey", new ValueWithNote("19071840", "honey preparation") }, // honey and honey preparation refer to the same medication
            ...
            { "glyceryl trinitrate", new ValueWithNote("1361711", "nitroglycerin") }, // glyceryl trinitrate and nitroglycerin refer to the same medication
            ...
            { "levomepromazine", new ValueWithNote("19005147", "methotrimeprazine") }, // UK vs USAN name for the same drug
            ...
            { "ispaghula", new ValueWithNote("957797", "psyllium") }, 
            ...
            { "sodium dihydrogen phosphate", new ValueWithNote("990499", "sodium phosphate, monobasic") }, // refer to the same drug
            { "sodium feredetate", new ValueWithNote("19001131", "sodium ironedetate") }, // refer to the same drug
            ...
            { "methylthioninium chloride", new ValueWithNote("905518", "methylene blue") }, // refer to the same medication
            ...
            { "suxamethonium", new ValueWithNote("836208", "succinylcholine") }, // refer to the same drug
            ...
            { "varicella vaccine", new ValueWithNote("42800027", "varicella-zoster virus vaccine live (oka-merck) strain") }, // refer to the same substance
            ...
            { "tuberculin purified protein derivative", new ValueWithNote("19058274", "purified protein derivative of tuberculin") }, // refer to the same substance
            ...
            { "liquid paraffin", new ValueWithNote("908523", "mineral oil") }, // UK vs US naming
            ...
            { "carbomer 980", new ValueWithNote("19055217", "carbomer") },
            ...
            { "alum", new ValueWithNote("19115033", "aluminum potassium sulfate") }, // alum is the common name for aluminum potassium sulfate
            ...
            { "rfviia", new ValueWithNote("19065771", "eptacog alfa activated") }, // clinincal short hand
            ...
            { "senna", new ValueWithNote("938268", "sennosides, usp") }, // senna is the common name for sennosides
            ...
            { "moroctocog alfa", new ValueWithNote("46274287", "antihemophilic factor, human recombinant residues 743-1636 deleted") }, // refer to the same substance
            ...
            { "anti-d (rho) immunoglobulin", new ValueWithNote("535714", "rho(d) immune globulin") }, // refer to the same substance
            ...
            { "chlorphenamine", new ValueWithNote("1192710", "chlorpheniramine") }, 
            ...
            { "hypromellose ophthalmic", new ValueWithNote("36224190", "hypromellose Ophthalmic Product") },
            ...
            { "ganciclovir ophthalmic", new ValueWithNote("36222883", "Ganciclovir Ophthalmic Product") },
            ...
            { "sodium chloride nasal", new ValueWithNote("36227315", "sodium chloride Nasal Product") }, 
            ...
            { "oxymetazoline nasal", new ValueWithNote("925636", "oxymetazoline") },
            ...
            { "mefenamic acid", new ValueWithNote("19125195", "mefenamic acid") }, // non standard precise ingredient but maps to standard
            ...
            { "timolol ophthalmic", new ValueWithNote("36212886", "timolol ophthalmic Product") }, 
            ...
            { "immunoglobulin normal intramuscular", new ValueWithNote("505117", "intramuscular immunoglobulin") }, // refer to the same substance
            { "cetrimide-dimeticone", new ValueWithNote("36027191", "cetrimide / dimethicone") },
            { "flucloxacillin", new ValueWithNote("19054936", "floxacillin") }, // abreviation of flucloxacillin, which is the same substance
            { "folinic acid", new ValueWithNote("1388796", "leucovorin") }, // folinic acid is the same substance as leucovorin
            { "norethisterone", new ValueWithNote("1521369", "norethindrone") },
            ...
            { "varicella immunoglobulin", new ValueWithNote("543291", "varicella-zoster immune globulin") }, // refer to the same substance
            { "xylometazoline nasal", new ValueWithNote("943852", "xylometazoline") },
            // end of tom's review
            ...
            { "paracetamol-tramadol", new ValueWithNote("36030125", "acetaminophen / tramadol") },  // Acetaminophen is the US name for Paracetamol
            { "triamcinolone nasal", new ValueWithNote("36223384", "triamcinolone Nasal Product") }, 
            { "sodium citrate ophthalmic", new ValueWithNote("21134235", "sodium citrate Ophthalmic Solution") },
            ...
            { "ipratropium nasal", new ValueWithNote("36224639", "ipratropium Nasal Product") },
            ...
            { "beclometasone nasal", new ValueWithNote("1115572", "beclomethasone") },
            { "betamethasone-neomycin ophthalmic", new ValueWithNote("36212136", "betamethasone / neomycin ophthalmic product") },
            { "azelastine nasal", new ValueWithNote("36225519", "azelastine nasal Product") },
            { "gentamicin-hydrocortisone otic", new ValueWithNote("36029279", "gentamicin / hydrocortisone") },
            { "mometasone nasal", new ValueWithNote("36219416", "mometasone nasal Product") }, 
            { "budesonide nasal", new ValueWithNote("36213521", "budesonide nasal Product") },
            { "azelastine-fluticasone nasal", new ValueWithNote("36249521", "azelastine / fluticasone Nasal Product") },
            ...
            { "ephedrine nasal", new ValueWithNote("36220418", "ephedrine Nasal Product") },
            ...
            { "amylmetacresol-dichlorobenzyl alc top", new ValueWithNote("21290950", "Dichlorobenzyl alcohol + Amylmetacresol") },
            { "timolol-travoprost ophthalmic", new ValueWithNote("21050765", "Timolol / travoprost Ophthalmic Solution") },
            { "fluticasone nasal", new ValueWithNote("36220588", "fluticasone nasal product") },
            { "convalescent plasma", new ValueWithNote("36026940", "human plasma preparation") },
            { "clioquinol-flumetasone otic", new ValueWithNote("36681230", "Clioquinol and flumethasone only product in otic dose form") },
            ...
            { "chlorhexidine-fluoride", new ValueWithNote("36027304", "chlorhexidine / sodium fluoride") },   // In practice (especially in dental/oral products), “fluoride” almost always implies sodium fluoride
            ...
            { "fentanyl-levobupivacaine", new ValueWithNote("21062296", "Fentanyl / Levobupivacaine Injectable Solution") }, // Closest match to include both ingedients together
            ...
            { "antazoline-xylometazoline ophthalmic", new ValueWithNote("36211864", "antazoline / xylometazoline Ophthalmic Product") },
            { "argipressin (vasopressin)", new ValueWithNote("19006871", "argipressin") },
            { "betamethasone-fusidic acid", new ValueWithNote("3213156", "Betamethasone and fusidic acid product") },
            ...
            { "brinzolamide-timolol ophthalmic", new ValueWithNote("21130693", "brinzolamide / Timolol Ophthalmic Solution") }, 
            ...
            { "brimonidine-timolol ophthalmic", new ValueWithNote("36219536", "brimonidine / timolol Ophthalmic Product") },
            { "dorzolamide-timolol ophthalmic", new ValueWithNote("36224177", "dorzolamide / timolol Ophthalmic Product") },
            { "bimatoprost-timolol ophthalmic", new ValueWithNote("21060563", "bimatoprost / timolol ophthalmic solution") },
            { "liquid paraffin ophthalmic", new ValueWithNote("21290249", "mineral oil") },
            { "ichthammol-zinc oxide", new ValueWithNote("36030285", "ichthammol / zinc oxide") },
            { "tafluprost-timolol ophthalmic", new ValueWithNote("21022885", "tafluprost / Timolol Ophthalmic Solution") },
            { "trometamol (tham))", new ValueWithNote("19006047", "tromethamine") }, // tromethamine is US centric
            { "dexamethasone/neomycin/polymyxin b ophth", new ValueWithNote("36030056", "dexamethasone / neomycin / polymyxin B") },
            { "piperacillin-tazobactam (tazocin equival", new ValueWithNote("36030773", "piperacillin / tazobactam") },
            { "proxymetacaine ophthalmic", new ValueWithNote("36211818", "proparacaine Ophthalmic Product") },
            ...
            { "soft paraffin + wool fat", new ValueWithNote("19033354", "petrolatum") },
            { "corticotrophin releasing hormone", new ValueWithNote("19048699", "corticotropin-releasing hormone") },
            { "alginic acid/calcium carbonate/na bic", new ValueWithNote("1449975", "Calcium carbonate and sodium alginate and sodium bicarbonate only product") }, // Mapped to a non-standard specific product containing all three ingredients, so that our mapping will split it into the 3 ingredients
            { "calcium acetate-magnesium carbonate", new ValueWithNote("778779", "calcium acetate / magnesium carbonate") },
            { "aluminium acetate", new ValueWithNote("930604", "aluminum acetate") },
            { "polihexanide ophthalmic", new ValueWithNote("43525903", "polihexanide") },
            { "mercaptamine ophthalmic", new ValueWithNote("910888", "cysteamine") },
            { "liquid paraffin + isopropyl myristate", new ValueWithNote("998394", "heavy mineral oil") },
            { "mg acetate/mg carbonate/mg hydroxide", new ValueWithNote("19124906", "Magnesium") },
            { "continuous epidural infusion", new ValueWithNote("21215791", "Epidural infusion") },   // Non-standard with no standard mapping, but included for completeness
            { "dexamethasone-tobramycin ophthalmic", new ValueWithNote("36215046", "dexamethasone / tobramycin Ophthalmic Product") },
            { "ispaghula-mebeverine", new ValueWithNote("3207637", "Ispaghula husk and mebeverine product") },
            { "white soft paraffin + liquid paraffin", new ValueWithNote("19033354", "petrolatum") },
            { "potassium acid tartrate-potassium bicarb", new ValueWithNote("19049024", "potassium") },
            { "glucose 2.5% with 0.45% sodium chloride", new ValueWithNote("36249707", "glucose 25 mg/ml / sodium chloride 4.5 mg/ml injection") },
            { "imipenem/cilastatin/relebactam", new ValueWithNote("36030067", "cilastatin / imipenem / relebactam") },
            { "haemophilus b-meningococcal conj vaccine", new ValueWithNote("4313905", "Haemophilus influenzae type b + Meningococcal group C vaccine") }, 
            ...
            { "argx-119", new ValueWithNote("0", "argx-119") },
            { "covid-19 vaccine", new ValueWithNote("724904", "SARS-COV-2 (COVID-19) vaccine, UNSPECIFIED") }, 
            ...
            { "gelclair", new ValueWithNote("0", "gelclair") },
            { "enteral nutrition", new ValueWithNote("0", "enteral nutrition") },
            { "gtx-102", new ValueWithNote("0", "gtx-102") },
            { "insulin soluble", new ValueWithNote("19122121", "insulin") },
            { "ion582", new ValueWithNote("0", "ion582") },
            ...
            { "infant formulas", new ValueWithNote("0", "infant formulas") },
            ...
            { "probiotic", new ValueWithNote("0", "probiotic") },
            ...
            { "meningococcal conjugate vaccine", new ValueWithNote("0", "meningococcal conjugate vaccine") },
            ...
            { "beclometasone-formoterol", new ValueWithNote("37366910", "Beclomethasone / formoterol") }, 
            { "argx-117", new ValueWithNote("1253663", "Empasiprubart") },
            { "fluticasone-formoterol", new ValueWithNote("21235187", "Fluticasone + Formoterol") },
            { "metformin-vildagliptin", new ValueWithNote("37156391", "Metformin and vildagliptin only product") },
            ...
            { "shingles (herpes zoster) vaccine, live", new ValueWithNote("21272412", "Varicella Virus Vaccine Live (Oka-Merck) strain") },
            ...
            { "sodium acid phosphate + potassium dih", new ValueWithNote("19112944", "phosphate ion") },
            ...
            { "sodium lactate compound (hartmann's) inf", new ValueWithNote("19011035", "lactate") },
            ...
            { "be1116", new ValueWithNote("44507865", "prothrombin") },

            { "buffered sodium chloride 0.9% sterile iv", new ValueWithNote("967823", "sodium chloride") },
            ...
            { "fresh frozen plasma", new ValueWithNote("3087442", "Fresh frozen plasma, human") }, 
            ...
            { "ergometrine-oxytocin", new ValueWithNote("36678402", "Ergonovine and oxytocin only product") },
            ...
            { "magnesium carbonate-magnesium sulfate", new ValueWithNote("19124906", "magnesium") },
            ...
            { "calcium lactate + calcium phosphate +", new ValueWithNote("19018544", "calcium") },
            ...
            { "fat emulsion, intravenous", new ValueWithNote("4168305", "fat emulsion") },
            { "regn10933 + regn10987", new ValueWithNote("779055", "casirivimab / imdevimab") },
             { "incontinence supplies", new ValueWithNote("21289214", "Selective Supplies") },
             { "betamethasone-calcipotriol", new ValueWithNote("36677438", "Betamethasone and calcipotriol only product") },
             { "imc-i109v", new ValueWithNote("40213263", "unknown vaccine or immune globulin") },
             { "balsam/benzyl benz/bismuth/hc/zno top", new ValueWithNote("21041476", "benzyl benzoate / bismuth oxide / bismuth subgallate / Hydrocortisone / Peruvian balsam / Zinc Oxide Topical Ointment") },
             { "smof 60 (60ml)", new ValueWithNote("861721", "Fish / medium chain triglycerides / olive oil / soybean oil Injectable Suspension") },
             { "red cells", new ValueWithNote("37557253", "Red blood cells") },
             { "srp", new ValueWithNote("701783", "sodium ricinoleate") },
             { "ocular lubricant", new ValueWithNote("44013941", "Artificial Tears") },
             { "respiratory therapy supplies", new ValueWithNote("21289214", "Selective Supplies") },
             { "rsv vaccine, pref a-pref b, recombinant", new ValueWithNote("902414", "	Respiratory syncytial virus (RSV) vaccine, unspecified") },
             { "cinchocaine-prednisolone", new ValueWithNote("21235082", "Cinchocaine + Prednisolone") }, // Deprecated but maps to both ingredients as standard mappings
             { "cinchocaine-hydrocortisone", new ValueWithNote("21291083", "Cinchocaine + Hydrocortisone") },
             { "ro7204239", new ValueWithNote("1734659", "crovalimab") },
             { "ro7234292", new ValueWithNote("36851650", "GANTENERUMAB") },
             { "blood glucose monitoring supplies", new ValueWithNote("21289214", "Selective Supplies") },

             { "adult st8 parenteral nutrition bag", new ValueWithNote("0", "adult st8 parenteral nutrition bag") },
             { "adult st4 parenteral nutrition bag", new ValueWithNote("0", "adult st4 parenteral nutrition bag") },
             { "adult st3 parenteral nutrition bag", new ValueWithNote("0", "adult st3 parenteral nutrition bag") },
             { "adult st6 parenteral nutrition bag", new ValueWithNote("0", "adult st6 parenteral nutrition bag") },
             { "adult st5 parenteral nutrition bag", new ValueWithNote("0", "adult st5 parenteral nutrition bag") },
             { "adult st7 parenteral nutrition bag", new ValueWithNote("0", "adult st7 parenteral nutrition bag") },
             { "adult st9 parenteral nutrition bag", new ValueWithNote("0", "adult st9 parenteral nutrition bag") },
             { "adult st2 parenteral nutrition bag", new ValueWithNote("0", "adult st2 parenteral nutrition bag") },
             { "plx-pad cells", new ValueWithNote("0", "plx-pad cells") },
             { "adult st7e parenteral nutrition bag", new ValueWithNote("0", "adult st7e parenteral nutrition bag") },
             { "adult st1b parenteral nutrition bag", new ValueWithNote("0", "adult st1b parenteral nutrition bag") },
             { "adult st1a parenteral nutrition bag", new ValueWithNote("0", "adult st1a parenteral nutrition bag") },
             { "wound care supplies", new ValueWithNote("0", "wound care supplies") },
             { "parenteral nutrition (adults)", new ValueWithNote("0", "parenteral nutrition (adults)") },
             { "parenteral nutrition (paediatric)", new ValueWithNote("0", "parenteral nutrition (paediatric)") },
             { "ready diluted", new ValueWithNote("0", "ready diluted") },
             { "intermittent pneumatic compression (ipc)", new ValueWithNote("0", "intermittent pneumatic compression (ipc)") },
             { "freetext medication", new ValueWithNote("0", "freetext medication") },
             { "nca", new ValueWithNote("0", "nca") },
             { "blood level monitoring (neonatal unit)", new ValueWithNote("0", "blood level monitoring (neonatal unit)") },
             { "carnoys solution", new ValueWithNote("0", "carnoys solution") },
             { "emollients,", new ValueWithNote("0", "emollients,") },
             { "donor lymphocytes - cd3", new ValueWithNote("0", "donor lymphocytes - cd3") },
             { "idds", new ValueWithNote("0", "idds") },
             { "granulocytes", new ValueWithNote("0", "granulocytes") },
             { "parenteral nutrition (neonatal unit)", new ValueWithNote("0", "parenteral nutrition (neonatal unit)") },
             { "ncea", new ValueWithNote("0", "ncea") },
             { "nutritional supplements", new ValueWithNote("0", "nutritional supplements") },
             { "peripheral nerve infusion", new ValueWithNote("0", "peripheral nerve infusion") },
             { "radio-opaque markers", new ValueWithNote("0", "radio-opaque markers") },
             { "vitamins", new ValueWithNote("0", "vitamins") },
             { "saliva substitutes", new ValueWithNote("0", "saliva substitutes") },
             { "support devices", new ValueWithNote("0", "support devices") },
             { "stem cells - cd34", new ValueWithNote("0", "stem cells - cd34") },
             { "pcea", new ValueWithNote("0", "pcea") },    // Patient-Controlled Epidural Analgesia - A device
             { "vitamins with minerals", new ValueWithNote("0", "vitamins with minerals") },
        };
