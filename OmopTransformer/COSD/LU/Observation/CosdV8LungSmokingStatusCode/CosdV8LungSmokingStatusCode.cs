...
internal class CosdV8LungSmokingStatusCode : OmopObservation<CosdV8LungSmokingStatusCodeRecord>
{
    ...
    [CopyValue(nameof(Source.SmokingStatusCode))]
    public override string? value_source_value { get; set; }

    [Transform(typeof(SmokingStatusLookup), nameof(Source.SmokingStatusCode))]
