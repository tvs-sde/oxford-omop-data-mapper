...
internal class COSDv8CTMeasurementLactateDehydrogenaseLevelNormalUpperLimit : OmopMeasurement<COSDv8CTMeasurementLactateDehydrogenaseLevelNormalUpperLimitRecord>
{
    ...
    [CopyValue(nameof(Source.LactateDehydrogenaseLevelNormalUpperLimit))]
    public override string? measurement_source_value { get; set; }

    [ConstantValue(4012918, "Lactate dehydrogenase measurement")]
    public override int[]? measurement_concept_id { get; set; }

    [Transform(typeof(DoubleParser), nameof(Source.LactateDehydrogenaseLevelNormalUpperLimit))]
