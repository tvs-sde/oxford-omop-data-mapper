...
internal class COSDv8UGMeasurementIntegratedStageNCategory : OmopMeasurement<COSDv8UGMeasurementIntegratedStageNCategoryRecord>
{
    ...
    [CopyValue(nameof(Source.IntegratedStageNCategory))]
    public override string? measurement_source_value { get; set; }

    [Transform(typeof(NCategoryLookup), nameof(Source.IntegratedStageNCategory))]
