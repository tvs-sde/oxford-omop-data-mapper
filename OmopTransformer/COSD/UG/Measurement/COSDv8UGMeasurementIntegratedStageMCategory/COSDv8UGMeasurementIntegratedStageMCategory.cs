...
internal class COSDv8UGMeasurementIntegratedStageMCategory : OmopMeasurement<COSDv8UGMeasurementIntegratedStageMCategoryRecord>
{
    ...
    [CopyValue(nameof(Source.IntegratedStageMCategory))]
    public override string? measurement_source_value { get; set; }

    [Transform(typeof(MCategoryLookup), nameof(Source.IntegratedStageMCategory))]
