...
internal class COSDv8UGMeasurementFinalPretreatmentTCategory : OmopMeasurement<COSDv8UGMeasurementFinalPretreatmentTCategoryRecord>
{
    ...
    [CopyValue(nameof(Source.FinalPreTreatmentTCategory))]
    public override string? measurement_source_value { get; set; }

    [Transform(typeof(TCategoryLookup), nameof(Source.FinalPreTreatmentTCategory))]
