...
internal class COSDv8HAMeasurementFinalPreTreatmentNCategory : OmopMeasurement<COSDv8HAMeasurementFinalPreTreatmentNCategoryRecord>
{
    ...
    [CopyValue(nameof(Source.FinalPreTreatmentNCategory))]
    public override string? measurement_source_value { get; set; }

    [Transform(typeof(NCategoryLookup), nameof(Source.FinalPreTreatmentNCategory))]
