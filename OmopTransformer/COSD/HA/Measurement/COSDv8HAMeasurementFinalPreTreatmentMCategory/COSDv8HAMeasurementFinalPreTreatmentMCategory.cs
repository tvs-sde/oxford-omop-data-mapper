...
internal class COSDv8HAMeasurementFinalPreTreatmentMCategory : OmopMeasurement<COSDv8HAMeasurementFinalPreTreatmentMCategoryRecord>
{
    ...
    [CopyValue(nameof(Source.FinalPreTreatmentMCategory))]
    public override string? measurement_source_value { get; set; }

    [Transform(typeof(MCategoryLookup), nameof(Source.FinalPreTreatmentMCategory))]
